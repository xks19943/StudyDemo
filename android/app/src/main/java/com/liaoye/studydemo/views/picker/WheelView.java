...
package com.liaoye.studydemo.views.picker;
...
import com.liaoye.studydemo.views.picker.adapters.WheelViewAdapter;
...
//			0xffFFFFFF, 0x3fE9E9E9 };
    ...
    private void drawCenterRect(Canvas canvas) {
        ...
        paint.setColor(getResources().getColor(R.color.line_border));
        // 设置线宽
